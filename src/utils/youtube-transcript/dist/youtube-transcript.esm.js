    ...
    static fetchTranscript(videoId, config) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (transcriptBody.length === 0) {
                try {
                    const InnerTubeApiResponse = yield fetch('https://www.youtube.com/youtubei/v1/player', {
                        method: 'POST',
                        headers: {
                    ...
                    if (InnerTubeApiResponse.ok) {
                        const innerTubeData = yield InnerTubeApiResponse.json();
                        const innerTubeCaptions = (_b = innerTubeData === null || innerTubeData === void 0 ? void 0 : innerTubeData.captions) === null || _b === void 0 ? void 0 : _b.playerCaptionsTracklistRenderer;
                        if (innerTubeCaptions && innerTubeCaptions.captionTracks) {
                            const innerTubeTranscriptURL = ((config === null || config === void 0 ? void 0 : config.lang) ? innerTubeCaptions.captionTracks.find((track) => track.languageCode === (config === null || config === void 0 ? void 0 : config.lang))
                                : innerTubeCaptions.captionTracks[0]).baseUrl;
                            const innerTubeTranscriptResponse = yield fetch(innerTubeTranscriptURL, {
                                headers: Object.assign(Object.assign({}, ((config === null || config === void 0 ? void 0 : config.lang) && { 'Accept-Language': config.lang })), { 'User-Agent': USER_AGENT, 'Referer': `https://www.youtube.com/watch?v=${identifier}` }),
                            });
                            if (innerTubeTranscriptResponse.ok) {
                                const innerTubeTranscriptBody = yield innerTubeTranscriptResponse.text();
                                if (innerTubeTranscriptBody.length > 0) {
                                    ...
                                    return results.map((result) => {
                                        ...
                                        return ({
                                            ...
                                            lang: (_a = config === null || config === void 0 ? void 0 : config.lang) !== null && _a !== void 0 ? _a : innerTubeCaptions.captionTracks[0].languageCode,
                                        });
                                    });
                                }
                            }
